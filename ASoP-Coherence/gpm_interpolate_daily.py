...
basedir = '/gws/nopw/j04/klingaman/datasets/GPM_IMERG/daily/'+str(year)
...
basefile = os.path.splitext(basedir+'/3B-DAY.MS.MRG.3IMERG.'+str(year)+'.V06.3x3.nc')[0]
print(basefile)
iris.save(out_cube,basefile+'.3x3.nc')
